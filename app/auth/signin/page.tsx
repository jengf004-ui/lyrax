...
function getAttemptData(): AttemptData {
  try {
    ...
    // Ignore malformed sessionStorage values.
  }
    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <div className="flex min-h-[calc(100vh-64px)] items-center justify-center px-4 py-12">
        <div className="w-full max-w-md rounded-lg border border-border bg-card p-8 shadow-lg">
          ...
          {isVerified && (
            <div className="mb-6 animate-fade-in rounded-xl border border-green-500/30 bg-green-500/5 p-5 text-center">
          ...
          {isLockedOut && (
            <div className="mb-6 animate-fade-in rounded-xl border border-destructive/30 bg-destructive/5 p-5 text-center">
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full rounded-lg border bg-background px-4 py-2 text-foreground placeholder:text-muted-foreground transition-colors focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50 ${
                    emailError
                ...
                />
                {emailError && (
                  <AlertCircle className="absolute right-3 top-1/2 size-5 -translate-y-1/2 text-destructive" />
                )}
              </div>
              {emailError && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  disabled={isLockedOut}
                  className="w-full rounded-lg border border-input bg-background px-4 py-2 text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50"
                />
                <button
                  type="button"
                  ...
                  {Array.from({ length: MAX_ATTEMPTS }).map((_, index) => (
                    <div
                      ...
                      className={`h-1.5 w-5 rounded-full transition-colors ${
                        index < failedAttempts ? "bg-destructive" : "bg-border"
                      }`}
                    />
                  ))}
                </div>
            ...
            <button
              type="submit"
              disabled={loading || Boolean(emailError) || isLockedOut}
          ...
          <button
            ...
            disabled={isLockedOut}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-input bg-background px-4 py-2 font-medium text-foreground transition-colors hover:bg-accent disabled:cursor-not-allowed disabled:opacity-50"
          >
